...
private enum class LinuxSyscall(
    ...
    MLOCK(149, MemoryLockSyscalls::lock),
    MUNLOCK(150, MemoryLockSyscalls::unlock),
    ...
    S_AFFINITY(203, SchedulerSyscalls::setAffinity),
    G_AFFINITY(204, SchedulerSyscalls::getAffinity),
    ...
    MLOCK2(325, MemoryLockSyscalls::lockOnFault),
