...
private const val PAGE_SIZE_BYTES = 4096uL
...
class MemoryRegionMapBenchmark {
    ...
    fun prepare() {
        ...
        map = MemoryRegionMap(PAGE_SIZE_BYTES, addressLimit, addressLimit, PAGE_SIZE_BYTES)
    ...
    @Benchmark
    fun findFragmentedUnmappedArea(): Any? =
