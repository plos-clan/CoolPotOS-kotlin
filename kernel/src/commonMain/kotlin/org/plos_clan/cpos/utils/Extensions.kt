...
fun UInt.hasBit(index: Int): Boolean =
    index in 0 until UInt.SIZE_BITS && ((this shr index) and 1u) != 0u

fun ByteArray.readULongLE(offset: Int): ULong = LittleEndianBuffer(this).readU64(offset)

fun Long.toByteArray(): ByteArray {
    return ByteArray(8).also {
        LittleEndianBuffer(it).writeU64(0, this.toULong())
    }
}
