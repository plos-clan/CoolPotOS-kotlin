...
interface BufferSource {
    ...
    fun copyTo(sourceOffset: Int, destination: BufferDestination, destinationOffset: Int, count: Int): Int
}
...
interface BufferDestination {
    ...
    fun copyFrom(destinationOffset: Int, source: BufferSource, sourceOffset: Int, count: Int): Int
...
value class PreparedBufferSource internal constructor(
    ...
    fun copyTo(sourceOffset: Int, destination: BufferDestination, destinationOffset: Int, count: Int): Int =
        source.copyTo(sourceOffset, destination, destinationOffset, count)
}
...
value class PreparedBufferDestination internal constructor(
    ...
    fun copyFrom(destinationOffset: Int, source: BufferSource, sourceOffset: Int, count: Int): Int =
        destination.copyFrom(destinationOffset, source, sourceOffset, count)
...
class ByteArrayBuffer(private val bytes: ByteArray) : IoBuffer {
    override fun copyTo(sourceOffset: Int, destination: BufferDestination, destinationOffset: Int, count: Int): Int {
        ...
        return destination.copyFrom(destinationOffset, bytes, sourceOffset, count)
    }
    ...
    override fun copyFrom(
        ...
        require(validRange(destinationOffset, count))
        return source.copyTo(sourceOffset, bytes, destinationOffset, count)
    }
